...
class Repo:
    ...
    def _load_json(self):
        ...
        if os.path.isfile(json_path):
            ...
            self._depth_to_last_tag = json_data['depth_to_last_tag']
    ...
    def tag(self, none = None):
        ...
        if self._last_tag == None or self._depth_to_last_tag != 0:
            return none
        else:
    ...
    def label(self):
        ...
        try:
            if self._depth_to_last_tag == 0:
                return self._last_tag + self.dirty()
            else:
                return self._last_tag + "+r" + self._depth_to_last_tag + "-g" + self.hash(7, '') + self.dirty()
        except:
            return None
    ...
    def save_to_json(self, path):
        ...
        json_data['depth_to_last_tag'] = self._depth_to_last_tag
